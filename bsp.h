...
const nrfx_gpiote_pin_t pin_en_1v2 = NRF_GPIO_PIN_MAP(0, 9);
const nrfx_gpiote_pin_t pin_en_12v = NRF_GPIO_PIN_MAP(0, 10);
...
const nrfx_gpiote_pin_t pin_nen_10v = NRF_GPIO_PIN_MAP(0, 17);
...
const nrfx_gpiote_pin_t pin_fpga_ncs = NRF_GPIO_PIN_MAP(0, 28);
